package com.example.Uber_DriverService.api;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> dataIntegrity(DataIntegrityViolationException ex) {
        ...
        return error(HttpStatus.CONFLICT, "Email may already be registered or data constraint failed");
    }
