package com.example.Uber_NotificationService.configurations;
...
public class KafkaConfig {
    ...
    public NewTopic notificationEventsTopic() {
        return new NewTopic("notification-events-topic", 1, (short) 1);
    }

    @Bean
    public ConsumerFactory<String, NotificationEventDto> consumerFactory() {
        JsonDeserializer<NotificationEventDto> deserializer =
