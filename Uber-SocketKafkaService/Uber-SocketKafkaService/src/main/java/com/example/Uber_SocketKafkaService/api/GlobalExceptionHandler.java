package com.example.Uber_SocketKafkaService.api;
...
/**
 * REST controllers only (e.g. {@code /api/socket/**}). STOMP message handlers use separate error channels.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> fallback(Exception ex) {
        log.error("Unhandled error in Socket/Kafka REST layer", ex);
